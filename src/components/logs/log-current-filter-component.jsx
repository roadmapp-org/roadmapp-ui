    ...
    return (
        <div className={`flex flex-col items-center mb-8 pt-5`}>
            <div className="flex justify-center text-center content-center">
                <div className={`bg-custom-blue rounded-md py-1 px-2 relative grow-0 ${currentProject != 0 ? "block" : "hidden"} text-center content-center`}>
                ...
                <div className={`bg-custom-blue rounded-md py-1 px-2 relative grow-0 ml-4 ${currentTask != 0 ? "block" : "hidden"} text-center content-center`}>
