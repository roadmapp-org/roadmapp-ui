    ...
    return (
        <form method="post" onSubmit={onSubmit} className="space-y-4 flex flex-col md:flex-row md:items-end justify-evenly">
            ...
            <input
                ...
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-cyan-900 focus:bg-cyan-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 md:w-[20%]"
            />
        </form>
    );
}